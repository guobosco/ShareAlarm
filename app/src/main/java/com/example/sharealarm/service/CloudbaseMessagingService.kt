...
import com.tencent.cloudbase.messaging.CloudbaseMessagingService
import com.tencent.cloudbase.messaging.RemoteMessage

/**
 * Cloudbase 消息服务
 * 功能：处理 Cloudbase 推送通知，包括设备令牌的获取和推送消息的接收
 */
class MyCloudbaseMessagingService : CloudbaseMessagingService() {

    // 日志标签
    private val TAG = "MyCloudbaseMessagingService"
